...
\nDefinition{Problems with gradient descent}{
    ...
    \nDefinition{Regularization}{
        The process of limiting complexity of parameters or extreme values. For example in linear regression we can add a secondary objective to the optimization problem i.e. $\vec{w}$ being as small as possible (perhaps via lagrange multipliers)
    }
